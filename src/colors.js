export default [
    ...
    {code: 'bg-1', title: 'Камень песчаник', class: 'colorbg bg-1', bgColor: '', textColor: '', groups: ['Рисунок']},
    {code: 'bg-2', title: 'Камень природный', class: 'colorbg bg-2', bgColor: '', textColor: '', groups: ['Рисунок']},
    {code: 'bg-3', title: 'Темное дерево', class: 'colorbg bg-3', bgColor: '', textColor: '', groups: ['Рисунок']},
    {code: 'bg-4', title: 'Светлое дерево', class: 'colorbg bg-4', bgColor: '', textColor: '', groups: ['Рисунок']},
    {code: 'bg-5', title: 'Кирпич', class: 'colorbg bg-5', bgColor: '', textColor: '', groups: ['Рисунок']},
];